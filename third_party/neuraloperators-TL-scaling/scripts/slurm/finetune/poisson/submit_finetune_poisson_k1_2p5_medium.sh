#!/bin/bash
#SBATCH --job-name=neuralop-poisson-k1_2p5-medium
...
# Transfer Learning: Poisson k∈[1,2.5] - Medium Sample Sizes (4k, 8k samples)
# This script runs 4 experiments:
#   - 2 fine-tuning experiments (4k, 8k samples) with pre-trained weights from k1_5
...
experiments=(
    ...
    "poisson-k1_2.5-finetune-8k:finetune-k1_5-8k-samples"
    # From-scratch experiments (tasks 2-3)
    "poisson-k1_2.5-scratch-4k:scratch-4k-samples"
    "poisson-k1_2.5-scratch-8k:scratch-8k-samples"
)
