...
Run from the neuraloperators-TL-scaling repo root, e.g.:
    python eval_helmholtz_zeroshot_scales_ablation.py --device cuda:0
"""
...
def main():
    ...
    results: Dict[str, Any] = {
        "meta": {
            "script": "eval_helmholtz_zeroshot_scales_ablation.py",
