...
usage() {
  cat <<'EOF'
Usage:
  bash scripts/eval/run_mixed_zeroshot_bundle.sh [--root-dir DIR] [--summary-file PATH] [--python BIN] \
    <spec> [<spec> ...]
...
Options:
  --root-dir DIR
      Root dir passed to scripts/entrypoints/eval.py. Default: experiments_zeroshot
