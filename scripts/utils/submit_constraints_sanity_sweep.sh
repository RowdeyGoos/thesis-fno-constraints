...
#
# Usage:
#   bash scripts/utils/submit_constraints_sanity_sweep.sh [agent_array]
#
# Example:
#   bash scripts/utils/submit_constraints_sanity_sweep.sh
#   bash scripts/utils/submit_constraints_sanity_sweep.sh 0-1
...
bash scripts/utils/submit_constraints_sweep.sh config/sweep_constraints_sanity_smoke.yaml "$AGENT_ARRAY"
