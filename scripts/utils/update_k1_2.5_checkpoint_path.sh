...
# Usage: bash scripts/utils/update_k1_2.5_checkpoint_path.sh <JOBID>

if [ $# -eq 0 ]; then
    echo "Usage: bash scripts/utils/update_k1_2.5_checkpoint_path.sh <JOBID>"
    echo ""
    echo "Example:"
    echo "  bash scripts/utils/update_k1_2.5_checkpoint_path.sh 12345678"
    echo ""
