...
#
# Usage:
#   bash scripts/utils/convert_o1_5_to_mixed_format.sh
...
if [ $missing -eq 1 ]; then
    ...
    echo ""
    echo "  python utils/gen_data_helmholtz.py --ntrain 32768 --nval 4096 --ntest 4096 \\"
...
for dataset in "${DATASETS[@]}"; do
    ...
    python utils/convert_helmholtz_to_mixed_format.py \
        --input_path "$dataset" \
        --in_place
