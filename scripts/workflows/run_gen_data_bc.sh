...
generate_poisson_bc() {
    ...
    "$PYTHON_BIN" scripts/data/gen_data_poisson_bc.py --ntrain="$ntrain" --nval="$nval" --ntest="$ntest" \
...
generate_advdiff_bc() {
    ...
    "$PYTHON_BIN" scripts/data/gen_data_advdiff_bc.py --ntrain="$ntrain" --nval="$nval" --ntest="$ntest" \
                        --ng="$ng" --sparse --n "$n" --datapath "$datapath" \
...
generate_helmholtz_bc() {
    ...
    "$PYTHON_BIN" scripts/data/gen_data_helmholtz_bc.py --ntrain="$ntrain" --nval="$nval" --ntest="$ntest" \
                        --ng="$ng" --sparse --n "$n" --datapath "$datapath" \
