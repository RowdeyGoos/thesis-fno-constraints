...
python scripts/data/gen_data_poisson.py --ntrain=$ntrain --nval=$nval --ntest=$ntest \
                    --ng=$ng --sparse --n 128 --datapath $datapath --e1 $e1 --e2 $e2
# create AD examples
#python scripts/data/gen_data_advdiff.py --ntrain=$ntrain --nval=$nval --ntest=$ntest \
#                    --ng=$ng --sparse --n 128 --datapath $datapath --adr1 $adr1 --adr2 $adr2
# create Helm examples
#python scripts/data/gen_data_helmholtz.py --ntrain=$ntrain --nval=$nval --ntest=$ntest \
