...
#
# Usage:
#   bash scripts/data/convert_adr0p2_0p4_to_mixed_format.sh
...
if [ $missing -eq 1 ]; then
    ...
    echo ""
    echo "  python scripts/data/gen_data_advdiff.py --train_samples 32768 --val_samples 4096 --test_samples 4096 \\"
...
for dataset in "${DATASETS[@]}"; do
    ...
    python scripts/data/convert_ad_to_mixed_format.py \
        --input_path "$dataset" \
        --in_place
...
echo "     bash scripts/maintenance/update_mixed_checkpoint_path.sh <mixed_pretrain_job_id>"
