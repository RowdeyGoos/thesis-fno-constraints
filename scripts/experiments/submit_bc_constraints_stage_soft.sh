...
#
# Usage:
#   bash scripts/experiments/submit_bc_constraints_stage_soft.sh [agent_array]
#
# Example:
#   bash scripts/experiments/submit_bc_constraints_stage_soft.sh
#   bash scripts/experiments/submit_bc_constraints_stage_soft.sh 0-7
...
LAUNCH_SCRIPT="scripts/experiments/submit_bc_constraints_sweep.sh"
