...
#
# Usage:
#   bash scripts/experiments/submit_constraints_zero_mode_only_compare.sh [agent_array]
#
# Example:
#   bash scripts/experiments/submit_constraints_zero_mode_only_compare.sh
#   bash scripts/experiments/submit_constraints_zero_mode_only_compare.sh 0-7
...
bash scripts/experiments/submit_constraints_sweep.sh "${SOFT_SWEEP_YAML}" "${AGENT_ARRAY}"
