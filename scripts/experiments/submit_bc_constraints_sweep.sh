...
#
# Usage:
#   bash scripts/experiments/submit_bc_constraints_sweep.sh [sweep_yaml] [agent_array]
#
# Example:
#   bash scripts/experiments/submit_bc_constraints_sweep.sh
#   bash scripts/experiments/submit_bc_constraints_sweep.sh config/sweep_constraints_pretrain_bc_soft.yaml 0-7

usage() {
  cat <<'EOF'
Usage: bash scripts/experiments/submit_bc_constraints_sweep.sh [sweep_yaml] [agent_array]
