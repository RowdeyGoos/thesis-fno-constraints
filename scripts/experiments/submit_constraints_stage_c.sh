...
#
# Usage:
#   bash scripts/experiments/submit_constraints_stage_c.sh <penalty|al> [agent_array]
#
# Example:
#   bash scripts/experiments/submit_constraints_stage_c.sh penalty
#   bash scripts/experiments/submit_constraints_stage_c.sh al 0-7

usage() {
  cat <<'EOF'
Usage: bash scripts/experiments/submit_constraints_stage_c.sh <penalty|al> [agent_array]
EOF
}
