...
#
# Usage:
#   bash scripts/experiments/submit_constraints_sweep.sh <sweep_yaml> [agent_array]
#
# Example:
#   bash scripts/experiments/submit_constraints_sweep.sh config/sweep_constraints_pretrain_penalty_pde_only.yaml
#   bash scripts/experiments/submit_constraints_sweep.sh config/sweep_constraints_pretrain_al_hard.yaml 0-7

usage() {
  cat <<'EOF'
Usage: bash scripts/experiments/submit_constraints_sweep.sh <sweep_yaml> [agent_array]
