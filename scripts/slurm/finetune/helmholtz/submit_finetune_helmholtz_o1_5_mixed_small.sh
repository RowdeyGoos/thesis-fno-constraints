...
declare -a configs=(
    "helm-o1_5-finetune-${MIXED_VARIANT}-16:finetune-${RUN_VARIANT}-16"
    "helm-o1_5-finetune-${MIXED_VARIANT}-64:finetune-${RUN_VARIANT}-64"
    "helm-o1_5-finetune-${MIXED_VARIANT}-256:finetune-${RUN_VARIANT}-256"
    "helm-o1_5-finetune-${MIXED_VARIANT}-1k:finetune-${RUN_VARIANT}-1k"
)
