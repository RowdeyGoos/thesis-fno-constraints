...
#   8 -> ad-adr0p2_0p4-finetune-mixed-256, seed2
#   9 -> ad-adr0p2_0p4-finetune-mixed-1k, seed0
...
declare -a configs=(
    "ad-adr0p2_0p4-finetune-${MIXED_VARIANT}-16:finetune-${RUN_VARIANT}-16"
    "ad-adr0p2_0p4-finetune-${MIXED_VARIANT}-64:finetune-${RUN_VARIANT}-64"
    "ad-adr0p2_0p4-finetune-${MIXED_VARIANT}-256:finetune-${RUN_VARIANT}-256"
    "ad-adr0p2_0p4-finetune-${MIXED_VARIANT}-1k:finetune-${RUN_VARIANT}-1k"
)
