#!/bin/bash
#SBATCH --job-name=eval-ood-advdiff
...
# Batch Evaluation: AdvDiff OOD degradation
#
# Evaluates the mixed-pretrained and scratch OOD runs across all AdvDiff OOD bins
...
if [ $status -eq 0 ]; then
    ...
    echo "  - JSON:             $OUTPUT_DIR/advdiff_ood_results.json"
    echo "  - Comparison plot:  $OUTPUT_DIR/advdiff_ood_comparison.png"
    echo "  - PDF plot:         $OUTPUT_DIR/advdiff_ood_comparison.pdf"
else
