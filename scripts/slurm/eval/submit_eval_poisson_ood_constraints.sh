#!/bin/bash
#SBATCH --job-name=eval-ood-poisson-constraints
...
# Batch Evaluation: Poisson OOD constraint comparison
#
# Evaluates the OOD Poisson runs across all default OOD bins for:
#   1) Mixed baseline
...
echo "=========================================="
echo "Poisson OOD Constraint Evaluation"
...
if [ $status -eq 0 ]; then
    ...
    echo "  - JSON:             $OUTPUT_DIR/poisson_ood_constraints_results.json"
    echo "  - 256 plot PNG:     $OUTPUT_DIR/poisson_ood_constraints_comparison_256.png"
    echo "  - 256 plot PDF:     $OUTPUT_DIR/poisson_ood_constraints_comparison_256.pdf"
    echo "  - 4K plot PNG:      $OUTPUT_DIR/poisson_ood_constraints_comparison_4k.png"
    echo "  - 4K plot PDF:      $OUTPUT_DIR/poisson_ood_constraints_comparison_4k.pdf"
else
