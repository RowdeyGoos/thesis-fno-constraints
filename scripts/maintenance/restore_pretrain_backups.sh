...
#
# Usage:
#   bash scripts/maintenance/restore_pretrain_backups.sh
#   bash scripts/maintenance/restore_pretrain_backups.sh --apply
#
...
usage() {
    cat <<EOF
Usage: bash scripts/maintenance/restore_pretrain_backups.sh [--apply] [--overwrite]
