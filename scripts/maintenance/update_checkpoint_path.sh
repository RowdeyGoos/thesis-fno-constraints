...
# Usage: bash scripts/maintenance/update_checkpoint_path.sh <pretrain_job_id>

if [ $# -eq 0 ]; then
    echo "Usage: bash scripts/maintenance/update_checkpoint_path.sh <pretrain_job_id>"
    echo ""
    echo "Example:"
    echo "  bash scripts/maintenance/update_checkpoint_path.sh 12345"
    echo ""
