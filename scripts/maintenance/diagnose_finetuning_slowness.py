...
Usage:
    python scripts/maintenance/diagnose_finetuning_slowness.py \
...
def check_dataset_format(data_path):
    ...
    with h5py.File(data_path, 'r') as f:
        ...
        if tensor_shape[1] == 3:
            ...
            print(f"      bash scripts/data/convert_k1_2.5_to_mixed_format.sh")
            return False
...
def main():
    ...
    if not dataset_ok:
        ...
        print("\n   Run this command:")
        print("   bash scripts/data/convert_k1_2.5_to_mixed_format.sh")
        return 1
    else:
